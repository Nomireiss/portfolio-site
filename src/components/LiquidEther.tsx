...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class ExternalForce extends ShaderPass {
      ...
      constructor(simProps: any) { super({ output: simProps.dst }); this.initForce(simProps); }
    ...
    class Simulation {
      options: any; fbos: any; fboSize = new THREE.Vector2();
      cellScale = new THREE.Vector2(); boundarySpace = new THREE.Vector2();
      advection: Advection | null = null; externalForce: ExternalForce | null = null;
      viscousPass: Viscous | null = null; divergence: Divergence | null = null;
      poisson: Poisson | null = null; pressure: Pressure | null = null;
      ...
      createAllFBO() {
        ...
        for (const key in this.fbos) this.fbos[key] = new THREE.WebGLRenderTarget(this.fboSize.x, this.fboSize.y, opts as any);
      }
      createShaderPass() {
    ...
    class WebGLManager {
      props: any; lastUserInteraction = performance.now();
      autoDriver: AutoDriver | null = null; output: Output | null = null;
      running = false; _loop: () => void; _resize: () => void; _onVisibility: () => void;
