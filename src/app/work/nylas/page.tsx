...
function PullQuote({ children }: { children: React.ReactNode }) {
  return (
    <p style={{ fontFamily: INTER, fontSize: "1.05rem", lineHeight: 1.8, color: "#2A2326", margin: "0 0 28px", textWrap: "pretty" } as React.CSSProperties}>
      {children}
    </p>
  );
}
...
function ImpactCallout({ children }: { children: React.ReactNode }) {
  return (
    <div style={{
      borderLeft: "3px solid #2A2326",
      paddingLeft: "20px",
      margin: "32px 0 0",
    }}>
      <p style={{ fontFamily: INTER, fontSize: "0.82rem", fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", color: "#8A7E72", margin: "0 0 6px" }}>
        Headline Impact
      </p>
      <p style={{ fontFamily: INTER, fontSize: "1rem", lineHeight: 1.7, color: "#2A2326", margin: 0 }}>
        {children}
      </p>
    </div>
  );
      ...
      <main style={{ backgroundColor: "#FBF8F3", minHeight: "100vh" }}>
        <div style={{ maxWidth: "1440px", margin: "0 auto", paddingLeft: pad, paddingRight: pad }}>
            ...
            <div style={{
              ...
              {[
                ...
                <div key={label} style={{ paddingRight: "24px" }}>
                  <p style={{ fontFamily: MONA, fontSize: "0.82rem", fontWeight: 400, letterSpacing: "0.1em", color: "#8A7E72", textTransform: "uppercase", margin: "0 0 8px" }}>{label}</p>
                  <p style={{ fontFamily: INTER, fontSize: "1rem", fontWeight: 500, lineHeight: 1.5, color: "#2A2326", margin: 0 }}>{value}</p>
                </div>
              ))}
            </div>
          ...
          <section style={{ maxWidth: "960px" }}>
            ...
            <p style={{ fontFamily: INTER, fontSize: "1.05rem", lineHeight: 1.8, color: "#2A2326", margin: "28px 0 0", fontWeight: 500 }}>
          ...
          <section style={{ maxWidth: "960px" }}>
            ...
            <p style={{ fontFamily: INTER, fontSize: "1rem", lineHeight: 1.75, color: "#2A2326", margin: "28px 0 0", fontWeight: 600 }}>
          ...
          <section style={{ maxWidth: "960px" }}>
            ...
            <p style={{ fontFamily: INTER, fontSize: "1rem", lineHeight: 1.75, color: "#2A2326", margin: "0 0 12px", fontWeight: 600 }}>
          ...
          <section style={{ maxWidth: "960px" }}>
            ...
            <p style={{ fontFamily: INTER, fontSize: "1.05rem", lineHeight: 1.8, color: "#2A2326", margin: "28px 0 0" }}>
          ...
          <div style={{ maxWidth: "960px" }}>
            ...
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "0.78rem", fontWeight: 400, letterSpacing: "0.04em", color: "#A6907E", textTransform: "uppercase", margin: "-24px 0 32px" }}>
          ...
          <section style={{ maxWidth: "960px", paddingBottom: "120px" }}>
            ...
            <p style={{ fontFamily: INTER, fontSize: "1.05rem", lineHeight: 1.8, color: "#2A2326", margin: 0 }}>
          ...
          <section style={{ paddingTop: "80px", paddingBottom: "120px" }}>
            <p style={{ fontFamily: MONA, fontSize: "1.1rem", fontWeight: 600, letterSpacing: "-0.01em", color: "#2A2326", marginBottom: "40px" }}>
              More work
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2" style={{ gap: "32px" }}>
              {[
                ...
                >
                  ...
                  <p style={{ fontFamily: MONA, fontSize: "1.15rem", fontWeight: 600, color: "#2A2326", margin: "0 0 4px", letterSpacing: "-0.02em" }}>
                    {project.title}
                  </p>
                  <p style={{ fontFamily: INTER, fontSize: "0.85rem", fontWeight: 400, color: "#8A7E72", margin: 0 }}>
                    {project.subtitle}
                  </p>
                </a>
              ))}
